"""
Wan2.2 T2V-A14B Text Encoder (UMT5) Compilation using Model Builder V2 API.

Same UMT5 text encoder architecture as TI2V-5B, adapted for T2V-A14B model.
"""
import os
import json
...
def compile_text_encoder(args):
    ...
    with NxDParallelState(world_size=world_size, tensor_model_parallel_size=tp_degree):
        ...
        # Save UNSHARDED state dict BEFORE sharding
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Compile Wan2.2 T2V-A14B Text Encoder")
