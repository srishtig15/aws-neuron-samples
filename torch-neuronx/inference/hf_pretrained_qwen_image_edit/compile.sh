...
# NEURON_RT_NUM_CORES=8 python run_qwen_image_edit.py --images image1.png --prompt "把女生变成男生" --transformer_batch_size 1 --cpu_vae_decode --output output_cpu_decode.png       
NEURON_RT_NUM_CORES=8 python run_qwen_image_edit.py --images image1.png --prompt "把女生变成男生" --transformer_batch_size 1 --save_comparison --output output_test.png
