...
echo ""
echo "[Step 2/4] Compiling Text Encoder (V2, TP=${TP_DEGREE})..."
...
# Step 4: Compile Decoder and post_quant_conv (V1)
# These don't need Context Parallel
echo ""
echo "[Step 4/4] Compiling Decoder and post_quant_conv (V1)..."
...
NEURON_RT_NUM_CORES=8 python run_wan2.2_ti2v_v3_cp.py \
